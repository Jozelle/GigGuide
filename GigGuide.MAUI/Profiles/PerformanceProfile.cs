    ...
    public class PerformanceProfile : Profile
    {
        public PerformanceProfile()
        {
            CreateMap<Performance,PerformanceDto>()
                ...
                .ForMember(dest => dest.TicketsBooked, opt => opt.MapFrom(src => src.PerformanceTicketsBooked))
            ...
            CreateMap<PerformanceDto, Performance>()
                ...
                .ForMember(dest => dest.PerformanceTicketsBooked, opt => opt.MapFrom(src => src.TicketsBooked))
